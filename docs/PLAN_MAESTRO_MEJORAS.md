...
| Q | Calidad ISO 17025 (SGC) | — | ◐ | ◐ | **C1✅ C2◐ C3 …+PG06+PG05✅** — siguiente PG08; detalle en `docs/quality/…` §0 |
...
- [ ] **Q.C3** Registros de gestión — **parcial (bloque MC01 cerrado):**
  ...
  - [ ] **Siguiente:** PG08 Revisión por la dirección
  - [ ] PG09-R3 · PG14-R5/R6 + QualityEquipment
