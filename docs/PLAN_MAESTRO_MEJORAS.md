...
| Q | Calidad ISO 17025 (SGC) | — | ◐ | ◐ | **C1✅ C2◐ C3 MC01+PG03✅** — siguiente PG07-R1; detalle en `docs/quality/…` §0 |
...
- [ ] **Q.C3** Registros de gestión — **parcial (bloque MC01 cerrado):**
  ...
  - [ ] **Siguiente:** PG07-R1 NC / TNC / Riesgos / OM
  - [ ] PG04 · PG06 · PG05 · PG08 · PG09-R3 · PG14-R5/R6 + QualityEquipment
