...
| **Estado C3 (07/09/2026):** | **EN CURSO — orden MC → PG.** Arranque por registros del Manual: **MC01-R01** instancias firmadas (listado/alta/PDF/anular) en `/calidad/registros/mc01-r01`. Siguiente: MC01-R02 → MC01-R03 → MC01-R05 → PG01… | — |
