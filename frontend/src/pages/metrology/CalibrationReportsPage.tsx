      ...
      <div className="page-head" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <div>
          ...
          <p className="muted" style={{ margin: 0, fontSize: "0.88rem" }}>
            Historial de protocolos e informes técnicos de ensayo de balanzas e instrumentos de pesar
          </p>
        </div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>Metrólogo / Técnico</th>
                  <th>Incertidumbre U</th>
                  <th>Dictamen</th>
                  <th>Próximo Ensayo</th>
                ...
                {reports.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td style={{ textAlign: "right" }}>
                      <Link to={`/metrologia/informes/${r.id}/imprimir`} className="btn ghost compact" target="_blank" title="Imprimir Informe de Ensayo">
                        🖨️ Imprimir
                      </Link>
                    </td>
                  </tr>
