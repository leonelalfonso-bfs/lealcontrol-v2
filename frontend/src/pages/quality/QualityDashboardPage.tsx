  ...
  return (
    <div className="workspace-page pad">
      ...
      <div style={{ display: "flex", gap: 12, marginTop: 24, flexWrap: "wrap" }}>
        ...
        <Link className="btn btn-outline" to="/calidad/registros/mc01-r01">MC01-R01 Interno</Link>
        <Link className="btn btn-outline" to="/calidad/registros/mc01-r02">MC01-R02 Externo</Link>
