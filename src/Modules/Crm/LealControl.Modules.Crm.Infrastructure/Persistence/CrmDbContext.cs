...
public sealed class CrmDbContext : DbContext, IUnitOfWork
{
    ...
    public async Task EnsureCrmTablesAsync()
    {
        try
        {
            ...
            // Huecos de producción: opportunities/activities faltantes. No crear crm.customers
            // a mano: un stub incompleto hace saltar MigrateAsync y el INSERT de clientes explota (500).
            await Database.ExecuteSqlRawAsync(@"
